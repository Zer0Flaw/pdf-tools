...
const ROUTES = [
  ...
  // Individual Docker error pages
  '/errors/docker-cannot-connect-to-daemon',
  '/errors/docker-permission-denied-sock',
  '/errors/docker-daemon-not-running',
  '/errors/docker-image-not-found',
  '/errors/docker-manifest-not-found',
  '/errors/docker-unauthorized-authentication-required',
  '/errors/docker-no-matching-manifest-platform',
  '/errors/docker-copy-file-not-found',
  '/errors/docker-build-failed-no-such-file',
  '/errors/docker-returned-non-zero-code',
  '/errors/docker-dockerfile-parse-error',
  '/errors/docker-failed-to-read-dockerfile',
  '/errors/docker-port-already-in-use',
  '/errors/docker-container-exited-code-137',
  '/errors/docker-container-exited-code-127',
  '/errors/docker-container-exited-code-1',
  '/errors/docker-exec-not-running',
  '/errors/docker-no-space-left-on-device',
  '/errors/docker-device-or-resource-busy',
  '/errors/docker-network-endpoint-exists',
  '/errors/docker-dns-resolution-failed',
  '/errors/docker-network-connect-refused',
  '/errors/docker-volume-mount-permission-denied',
  '/errors/docker-volume-path-not-found',
  '/errors/docker-compose-service-not-found',
  '/errors/docker-compose-version-unsupported',
  '/errors/docker-compose-port-conflict',
  '/errors/docker-compose-build-context-error',
  '/errors/docker-push-denied',
  '/errors/docker-tag-invalid',
]
