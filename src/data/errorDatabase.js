export const ERROR_DATABASE = [
  ...
  // ── Docker Errors ────────────────────────────────────────────────── //
  {
    ...
    slug: "docker-cannot-connect-to-daemon",
    ecosystem: "docker",
    pattern: /Cannot connect to the Docker daemon at unix:\/\/\/var\/run\/docker\.sock/i,
    title: "Cannot connect to the Docker daemon at unix:///var/run/docker.sock. Is the docker daemon running?",
    shortTitle: "Cannot connect to Docker daemon",
    explanation:
    ...
    example: {
      ...
      context: "Running docker ps on a Linux machine where the Docker service hasn't been started",
    },
    tags: ["docker", "daemon", "socket", "connection", "not running"],
    searchTerms: ["cannot connect to the docker daemon", "docker daemon not running", "docker.sock", "is the docker daemon running"],
  },
  {
    id: "docker-permission-denied-sock",
    slug: "docker-permission-denied-sock",
    ecosystem: "docker",
    pattern: /Got permission denied while trying to connect to the Docker daemon socket|permission denied.*docker\.sock/i,
    title: "Got permission denied while trying to connect to the Docker daemon socket at unix:///var/run/docker.sock",
    shortTitle: "Permission denied connecting to Docker socket",
    explanation:
    ...
    example: {
      ...
      context: "Running docker on Linux as a non-root user who hasn't been added to the docker group",
    },
    tags: ["docker", "permission", "denied", "socket", "docker group", "linux"],
    searchTerms: ["permission denied docker daemon socket", "docker permission denied", "docker group linux", "docker.sock permission"],
  },
  {
    id: "docker-daemon-not-running",
    slug: "docker-daemon-not-running",
    ecosystem: "docker",
    pattern: /Cannot connect to the Docker daemon\. Is the docker daemon running on this host/i,
    title: "Cannot connect to the Docker daemon. Is the docker daemon running on this host?",
    shortTitle: "Docker daemon not running on this host",
    explanation:
    ...
    example: {
      ...
      context: "Running a Docker build after rebooting a Linux server without enabling Docker to start at boot",
    },
    tags: ["docker", "daemon", "not running", "connection", "host"],
    searchTerms: ["docker daemon running on this host", "docker daemon not running", "cannot connect docker daemon host"],
  },
  {
    id: "docker-image-not-found",
    slug: "docker-image-not-found",
    ecosystem: "docker",
    pattern: /pull access denied|repository does not exist or may require 'docker login'|image.*not found/i,
    title: "Error response from daemon: pull access denied for X, repository does not exist or may require 'docker login'",
    shortTitle: "Image not found or pull access denied",
    explanation:
    ...
    example: {
      input: "$ docker pull myapp:latest\nError response from daemon: pull access denied for myapp, repository does not exist or may require 'docker login': denied: requested access to the resource is denied",
      context: "Pulling a private image from Docker Hub without being logged in",
    },
    tags: ["docker", "pull", "access denied", "image", "registry", "not found"],
    searchTerms: ["pull access denied", "repository does not exist", "docker login", "docker image not found"],
  },
  {
    id: "docker-manifest-not-found",
    slug: "docker-manifest-not-found",
    ecosystem: "docker",
    pattern: /manifest.*not found.*manifest unknown|manifest unknown.*manifest not found/i,
    title: "Error response from daemon: manifest for X:Y not found: manifest unknown: manifest unknown",
    shortTitle: "Image manifest not found (tag doesn't exist)",
    explanation:
    ...
    example: {
      input: "$ docker pull node:18-alpin\nError response from daemon: manifest for node:18-alpin not found: manifest unknown: manifest unknown",
      context: "Typo in the tag — 18-alpin instead of 18-alpine — the correct tag doesn't exist",
    },
    tags: ["docker", "manifest", "not found", "tag", "registry", "unknown"],
    searchTerms: ["manifest not found manifest unknown", "docker manifest unknown", "docker tag not found", "manifest unknown"],
  },
  {
    id: "docker-unauthorized-authentication-required",
    slug: "docker-unauthorized-authentication-required",
    ecosystem: "docker",
    pattern: /unauthorized: authentication required|unauthorized.*authentication/i,
    title: "Error response from daemon: unauthorized: authentication required",
    shortTitle: "Unauthorized — authentication required",
    explanation:
    ...
    example: {
      input: "$ docker pull registry.example.com/myapp:latest\nError response from daemon: unauthorized: authentication required",
      context: "Pulling from a private registry without having logged in first",
    },
    tags: ["docker", "unauthorized", "authentication", "login", "registry", "credentials"],
    searchTerms: ["unauthorized authentication required docker", "docker login required", "docker unauthorized", "authentication required registry"],
  },
  {
    id: "docker-no-matching-manifest-platform",
    slug: "docker-no-matching-manifest-platform",
    ecosystem: "docker",
    pattern: /no matching manifest for .*(aarch64|arm64|linux\/arm|linux\/amd64).*in the manifest list/i,
    title: "no matching manifest for linux/arm64/v8 in the manifest list entries",
    shortTitle: "No matching manifest for your CPU architecture",
    explanation:
    ...
    example: {
      input: "$ docker pull oldimage:latest\nUnable to find image 'oldimage:latest' locally\nno matching manifest for linux/arm64/v8 in the manifest list entries",
      context: "Pulling an AMD64-only image on an Apple Silicon Mac without specifying the platform",
    },
    tags: ["docker", "manifest", "arm64", "amd64", "apple silicon", "architecture", "platform"],
    searchTerms: ["no matching manifest for linux/arm64", "no matching manifest platform", "arm64 docker image", "apple silicon docker", "linux/arm64 manifest"],
  },
  {
    id: "docker-copy-file-not-found",
    slug: "docker-copy-file-not-found",
    ecosystem: "docker",
    pattern: /COPY failed.*file not found in build context|file not found in build context.*excluded by \.dockerignore/i,
    title: "COPY failed: file not found in build context or excluded by .dockerignore: stat X: file does not exist",
    shortTitle: "COPY file not found in build context",
    explanation:
    ...
    example: {
      input: "$ docker build -t myapp .\nCOPY failed: file not found in build context or excluded by .dockerignore: stat config/settings.json: file does not exist",
      context: "COPY instruction references config/settings.json but the file doesn't exist in the build context",
    },
    tags: ["docker", "COPY", "build context", "dockerfile", "dockerignore", "file not found"],
    searchTerms: ["COPY failed file not found in build context", "dockerignore excluding file", "docker copy file not found", "build context file not found"],
  },
  {
    id: "docker-build-failed-no-such-file",
    slug: "docker-build-failed-no-such-file",
    ecosystem: "docker",
    pattern: /failed to solve.*failed to compute cache key.*not found|failed to compute cache key.*no such file/i,
    title: "failed to solve: failed to compute cache key: \"/X\": not found",
    shortTitle: "Build failed — cache key file not found (BuildKit)",
    explanation:
    ...
    example: {
      input: "$ docker build .\n#5 [2/3] COPY dist/ /app/\n#5 ERROR: failed to solve: failed to compute cache key: \"/dist\": not found",
      context: "BuildKit can't find the dist/ directory — it wasn't created yet or doesn't exist in the build context",
    },
    tags: ["docker", "buildkit", "cache key", "not found", "COPY", "build", "failed to solve"],
    searchTerms: ["failed to solve failed to compute cache key", "buildkit cache key not found", "docker build failed not found", "failed to compute cache key"],
  },
  {
    id: "docker-returned-non-zero-code",
    slug: "docker-returned-non-zero-code",
    ecosystem: "docker",
    pattern: /The command '\/bin\/sh -c .*' returned a non-zero code|returned a non-zero code: [0-9]+/i,
    title: "The command '/bin/sh -c RUN_COMMAND' returned a non-zero code: 1",
    shortTitle: "RUN command returned non-zero exit code",
    explanation:
    ...
    example: {
      ...
      context: "npm install fails because package.json wasn't copied into the container before this RUN step",
    },
    tags: ["docker", "RUN", "non-zero", "build", "exit code", "command failed"],
    searchTerms: ["returned a non-zero code", "docker build failed non-zero", "RUN command failed dockerfile", "non-zero exit code docker build"],
  },
  {
    id: "docker-dockerfile-parse-error",
    slug: "docker-dockerfile-parse-error",
    ecosystem: "docker",
    pattern: /dockerfile parse error|Error response from daemon: dockerfile parse error/i,
    title: "Error response from daemon: dockerfile parse error at line X",
    shortTitle: "Dockerfile parse error",
    explanation:
    ...
    example: {
      input: "$ docker build .\nError response from daemon: dockerfile parse error line 5: unknown instruction: COPIES",
      context: "Typo in the Dockerfile — COPIES instead of COPY on line 5",
    },
    tags: ["docker", "dockerfile", "parse error", "syntax", "instruction"],
    searchTerms: ["dockerfile parse error", "docker dockerfile syntax error", "unknown instruction dockerfile", "docker build parse error"],
  },
  {
    id: "docker-failed-to-read-dockerfile",
    slug: "docker-failed-to-read-dockerfile",
    ecosystem: "docker",
    pattern: /failed to read dockerfile|open.*Dockerfile.*no such file or directory/i,
    title: "failed to read dockerfile: open /var/lib/docker/tmp/…/Dockerfile: no such file or directory",
    shortTitle: "Dockerfile not found in build context",
    explanation:
    ...
    example: {
      input: "$ docker build .\nerror: failed to read dockerfile: open /tmp/buildkit-mount123/Dockerfile: no such file or directory",
      context: "Running docker build . from a directory that contains a file named 'dockerfile' (lowercase) on Linux",
    },
    tags: ["docker", "dockerfile", "not found", "build", "file missing"],
    searchTerms: ["failed to read dockerfile", "dockerfile not found", "no such file or directory dockerfile", "docker build dockerfile missing"],
  },
  {
    id: "docker-port-already-in-use",
    slug: "docker-port-already-in-use",
    ecosystem: "docker",
    pattern: /address already in use|Error starting userland proxy.*bind.*already in use|listen tcp.*address already in use/i,
    title: "Error starting userland proxy: listen tcp 0.0.0.0:8080: bind: address already in use",
    shortTitle: "Port already in use",
    explanation:
    ...
    example: {
      input: "$ docker run -p 8080:8080 myapp\ndocker: Error response from daemon: driver failed programming external connectivity on endpoint myapp: Error starting userland proxy: listen tcp4 0.0.0.0:8080: bind: address already in use.",
      context: "Another process is already listening on port 8080 on the host",
    },
    tags: ["docker", "port", "address already in use", "bind", "userland proxy"],
    searchTerms: ["address already in use docker", "docker port conflict", "bind address already in use", "userland proxy listen tcp"],
  },
  {
    id: "docker-container-exited-code-137",
    slug: "docker-container-exited-code-137",
    ecosystem: "docker",
    pattern: /exit(?:ed)? (?:with )?(?:code |status )?137|OOMKilled|out of memory/i,
    title: "Container exited with code 137",
    shortTitle: "Container exited with code 137 (OOM or SIGKILL)",
    explanation:
    ...
    example: {
      input: "$ docker run --memory=256m myapp\n[...app output...]\n$ docker inspect myapp_1 | grep OOMKilled\n\"OOMKilled\": true",
      context: "Container hit the 256MB memory limit and was killed by the OOM killer",
    },
    tags: ["docker", "exit code 137", "OOM", "out of memory", "SIGKILL", "killed"],
    searchTerms: ["container exited with code 137", "docker exit code 137", "OOMKilled docker", "docker out of memory", "docker killed"],
  },
  {
    id: "docker-container-exited-code-127",
    slug: "docker-container-exited-code-127",
    ecosystem: "docker",
    pattern: /exit(?:ed)? (?:with )?(?:code |status )?127|exec.*not found|OCI runtime exec failed.*not found/i,
    title: "Container exited with code 127: exec: \"X\": executable file not found in $PATH",
    shortTitle: "Container exited with code 127 (command not found)",
    explanation:
    ...
    example: {
      input: "$ docker run myapp\ndocker: Error response from daemon: OCI runtime create failed: container_linux.go:380: starting container process caused: exec: \"myapp\": executable file not found in $PATH.",
      context: "The ENTRYPOINT binary doesn't exist in the image — it wasn't copied or installed during the build",
    },
    tags: ["docker", "exit code 127", "executable not found", "PATH", "entrypoint", "command not found"],
    searchTerms: ["container exited with code 127", "docker exit code 127", "executable file not found in PATH docker", "exec not found docker"],
  },
  {
    id: "docker-container-exited-code-1",
    slug: "docker-container-exited-code-1",
    ecosystem: "docker",
    pattern: /[Cc]ontainer (?:exited|failed).*(?:code|status)[: ]+1\b|[Ee]xit(?:ed)?(?: with)?(?: code)? 1\b.*docker/i,
    title: "Container exited with code 1",
    shortTitle: "Container exited with code 1 (application error)",
    explanation:
    ...
    example: {
      input: "$ docker run myapp\n$ docker ps -a\nCONTAINER ID   STATUS\nabc123def456   Exited (1) 3 seconds ago",
      context: "Container started but immediately exited — docker logs will show the actual error",
    },
    tags: ["docker", "exit code 1", "crash", "application error", "container stopped"],
    searchTerms: ["container exited with code 1", "docker exit code 1", "container crashed docker", "docker container exit 1"],
  },
  {
    id: "docker-exec-not-running",
    slug: "docker-exec-not-running",
    ecosystem: "docker",
    pattern: /Error response from daemon: Container [a-zA-Z0-9_-]+ is not running|is not running.*docker exec/i,
    title: "Error response from daemon: Container X is not running",
    shortTitle: "Container is not running (docker exec failed)",
    explanation:
    ...
    example: {
      input: "$ docker exec -it myapp /bin/sh\nError response from daemon: Container myapp is not running",
      context: "Trying to exec into a container that has already exited",
    },
    tags: ["docker", "exec", "not running", "container stopped", "container status"],
    searchTerms: ["container is not running docker exec", "docker exec is not running", "docker exec failed not running"],
  },
  {
    ...
    shortTitle: "No space left on device (Docker storage full)",
    explanation:
    ...
    example: {
      ...
      context: "Build fails midway because Docker's storage layer ran out of disk space",
    },
    tags: ["docker", "disk space", "ENOSPC", "storage", "prune", "full"],
    searchTerms: ["docker no space left on device", "docker disk full", "docker ENOSPC", "docker storage full", "docker prune"],
  },
  {
    id: "docker-device-or-resource-busy",
    slug: "docker-device-or-resource-busy",
    ecosystem: "docker",
    pattern: /device or resource busy|Error response from daemon.*device or resource busy/i,
    title: "Error response from daemon: device or resource busy",
    shortTitle: "Device or resource busy",
    explanation:
    ...
    example: {
      input: "$ docker volume rm myapp_data\nError response from daemon: remove myapp_data: volume is in use - [abc123, def456]",
      context: "Trying to remove a volume that two containers are still using",
    },
    tags: ["docker", "device busy", "resource busy", "volume", "container", "remove"],
    searchTerms: ["docker device or resource busy", "docker volume in use", "docker resource busy", "docker remove busy"],
  },
  {
    id: "docker-network-endpoint-exists",
    slug: "docker-network-endpoint-exists",
    ecosystem: "docker",
    pattern: /endpoint with name [a-zA-Z0-9_-]+ already exists in network/i,
    title: "Error response from daemon: endpoint with name X already exists in network Y",
    shortTitle: "Network endpoint already exists",
    explanation:
    ...
    example: {
      input: "$ docker run --name myapp --network mynet myimage\ndocker: Error response from daemon: endpoint with name myapp already exists in network mynet.",
      context: "A stopped container named myapp is still registered on the mynet network",
    },
    tags: ["docker", "network", "endpoint", "already exists", "container name", "conflict"],
    searchTerms: ["endpoint with name already exists in network", "docker network endpoint conflict", "docker name already in use network"],
  },
  {
    id: "docker-dns-resolution-failed",
    slug: "docker-dns-resolution-failed",
    ecosystem: "docker",
    pattern: /Temporary failure in name resolution|Could not resolve host.*inside container|failed to resolve DNS/i,
    title: "Temporary failure in name resolution / Could not resolve host",
    shortTitle: "DNS resolution failed inside container",
    explanation:
    ...
    example: {
      ...
      context: "Container can't reach external services because DNS isn't working inside the container",
    },
    tags: ["docker", "DNS", "resolution", "name resolution", "network", "hostname"],
    searchTerms: ["temporary failure in name resolution docker", "docker dns resolution failed", "could not resolve host docker", "docker container dns"],
  },
  {
    id: "docker-network-connect-refused",
    slug: "docker-network-connect-refused",
    ecosystem: "docker",
    pattern: /connect: connection refused.*docker|dial.*connect: connection refused/i,
    title: "connect: connection refused",
    shortTitle: "Connection refused inside container",
    explanation:
    ...
    example: {
      ...
      context: "App container tries to connect to localhost:5432, but the database is in a separate container — use the service name 'db' instead",
    },
    tags: ["docker", "connection refused", "network", "service", "localhost", "compose"],
    searchTerms: ["docker connection refused", "connect ECONNREFUSED docker", "container connection refused", "docker compose connection refused"],
  },
  {
    id: "docker-volume-mount-permission-denied",
    slug: "docker-volume-mount-permission-denied",
    ecosystem: "docker",
    pattern: /[Pp]ermission denied.*(?:mounted|mount|volume|bind mount)|bind mount.*[Pp]ermission denied/i,
    title: "Permission denied accessing files on a mounted volume",
    shortTitle: "Permission denied on mounted volume files",
    explanation:
    ...
    example: {
      input: "$ docker run -v $(pwd)/data:/app/data myapp\nError: EACCES: permission denied, open '/app/data/config.json'",
      context: "Container process running as UID 1001 can't read files owned by UID 1000 on the host",
    },
    tags: ["docker", "permission denied", "volume", "bind mount", "UID", "GID", "SELinux"],
    searchTerms: ["docker volume permission denied", "docker mount permission denied", "docker bind mount permission", "docker UID GID mismatch"],
  },
  {
    id: "docker-volume-path-not-found",
    slug: "docker-volume-path-not-found",
    ecosystem: "docker",
    pattern: /invalid mount config.*mount path must be absolute|mount path must be absolute/i,
    title: "Error response from daemon: invalid mount config for type \"bind\": invalid mount path: mount path must be absolute",
    shortTitle: "Volume mount path must be absolute",
    explanation:
    ...
    example: {
      input: "$ docker run -v ./data:/app/data myapp\ndocker: Error response from daemon: invalid mount config for type \"bind\": invalid mount path: 'data' mount path must be absolute.",
      context: "Relative path ./data used in docker run -v — Docker requires an absolute path here",
    },
    tags: ["docker", "volume", "mount", "absolute path", "bind mount", "invalid mount config"],
    searchTerms: ["mount path must be absolute docker", "invalid mount config docker", "docker relative path volume", "docker bind mount absolute path"],
  },
  {
    id: "docker-compose-service-not-found",
    slug: "docker-compose-service-not-found",
    ecosystem: "docker",
    pattern: /No such service: |ERROR.*No such service/i,
    title: "ERROR: No such service: X",
    shortTitle: "No such service in docker-compose.yml",
    explanation:
    ...
    example: {
      input: "$ docker-compose run webserver bash\nERROR: No such service: webserver",
      context: "Service is defined as 'web' in docker-compose.yml but command used 'webserver'",
    },
    tags: ["docker", "docker-compose", "service", "not found", "compose"],
    searchTerms: ["docker compose no such service", "ERROR No such service", "docker-compose service not found"],
  },
  {
    id: "docker-compose-version-unsupported",
    slug: "docker-compose-version-unsupported",
    ecosystem: "docker",
    pattern: /Version in.*docker-compose.*is unsupported|version.*unsupported.*docker.compose/i,
    title: "ERROR: Version in \"./docker-compose.yml\" is unsupported",
    shortTitle: "docker-compose.yml version unsupported",
    explanation:
      "The version declared at the top of your docker-compose.yml isn't supported by the Docker Compose version you have installed. Compose file format versions map to specific Docker Engine and Compose versions, and using a newer format with an older tool causes this error.",
    causes: [
    ...
    example: {
      input: "$ docker-compose up\nERROR: Version in \"./docker-compose.yml\" is unsupported: 3.9",
      context: "docker-compose.yml uses version '3.9' but the installed docker-compose only supports up to 3.7",
    },
    tags: ["docker", "docker-compose", "version", "unsupported", "compose file"],
    searchTerms: ["docker compose version unsupported", "version in docker-compose.yml is unsupported", "compose file version unsupported"],
  },
  {
    id: "docker-compose-port-conflict",
    slug: "docker-compose-port-conflict",
    ecosystem: "docker",
    pattern: /driver failed programming external connectivity|Cannot start service.*driver failed/i,
    title: "ERROR: for X: Cannot start service X: driver failed programming external connectivity on endpoint X",
    shortTitle: "Docker Compose port conflict (driver failed)",
    explanation:
    ...
    example: {
      input: "$ docker-compose up\nERROR: for nginx: Cannot start service nginx: driver failed programming external connectivity on endpoint: Error starting userland proxy: listen tcp4 0.0.0.0:80: bind: address already in use",
      context: "Port 80 is already in use by a local web server, preventing Docker Compose from binding to it",
    },
    tags: ["docker", "docker-compose", "port", "conflict", "driver failed", "external connectivity"],
    searchTerms: ["driver failed programming external connectivity", "docker compose port conflict", "cannot start service driver failed", "docker-compose port already in use"],
  },
  {
    id: "docker-compose-build-context-error",
    slug: "docker-compose-build-context-error",
    ecosystem: "docker",
    pattern: /build path .* (?:does not exist|is not accessible|is not a valid URL)|ERROR.*build path/i,
    title: "ERROR: build path X either does not exist, is not accessible, or is not a valid URL",
    shortTitle: "Docker Compose build context path error",
    explanation:
    ...
    example: {
      input: "$ docker-compose up --build\nERROR: build path /projects/app/services/api either does not exist, is not accessible, or is not a valid URL.",
      context: "The services/api directory doesn't exist at the path docker-compose.yml expects",
    },
    tags: ["docker", "docker-compose", "build context", "path", "does not exist"],
    searchTerms: ["docker compose build path does not exist", "build path either does not exist", "docker-compose build context error"],
  },
  {
    id: "docker-push-denied",
    slug: "docker-push-denied",
    ecosystem: "docker",
    pattern: /denied: requested access to the resource is denied|push.*access.*denied/i,
    title: "denied: requested access to the resource is denied",
    shortTitle: "Push denied — access to registry resource denied",
    explanation:
    ...
    example: {
      input: "$ docker push myimage:latest\nThe push refers to repository [docker.io/library/myimage]\ndenied: requested access to the resource is denied",
      context: "Pushing without a username prefix — library/ is reserved for official Docker images",
    },
    tags: ["docker", "push", "denied", "registry", "access", "permissions"],
    searchTerms: ["denied requested access to the resource is denied", "docker push denied", "docker push access denied", "docker registry push denied"],
  },
  {
    id: "docker-tag-invalid",
    slug: "docker-tag-invalid",
    ecosystem: "docker",
    pattern: /invalid reference format|Error parsing reference.*invalid reference format/i,
    title: "Error parsing reference: invalid reference format",
    shortTitle: "Invalid image reference format",
    explanation:
    ...
    example: {
      input: "$ docker pull My Image:latest\nError response from daemon: invalid reference format",
      context: "Image name has a space and uppercase letters, neither of which are valid in Docker image references",
    },
    tags: ["docker", "tag", "reference", "invalid format", "image name", "lowercase"],
    searchTerms: ["invalid reference format docker", "docker tag invalid", "docker image name invalid", "error parsing reference docker"],
  },
];
